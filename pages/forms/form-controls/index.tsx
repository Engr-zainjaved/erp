...
<Textarea
  ...
  return (
    <PageWrapper>
      <Head>
        <title>{componentPagesMenu.forms.subMenu.formControl.text}</title>
      </Head>
      <SubHeader>
        <SubHeaderLeft>
          <Breadcrumb
        ...
        <SubHeaderRight>
          <Dropdown>
            ...
            <DropdownMenu isAlignmentEnd>
              <DropdownItem>
                <CommonStoryLink to="/story/forms-input--default">Input</CommonStoryLink>
              </DropdownItem>
              <DropdownItem>
                <CommonStoryLink to="/story/forms-textarea--default">Textarea</CommonStoryLink>
              </DropdownItem>
            </DropdownMenu>
          </Dropdown>
        </SubHeaderRight>
        ...
        <div className="row">
              ...
              <CardBody>
                <div className="row">
                  <div className="col-lg-6">
                    <CardCodeView className="h-100">{GENERAL_USAGE}</CardCodeView>
                  </div>
                  <div className="col-lg-6">
                    <CardCodeView className="h-100">{GENERAL_USAGE_2}</CardCodeView>
                  </div>
                </div>
              </CardBody>
            </Card>
          ...
          <div className="col-lg-6">
            <Card stretch>
              ...
              <CardHeader>
                <CommonHowToUse>
                  type: PropTypes.oneOf([ 'text', 'email', 'password', 'file', 'color', 'date',
                  'datetime-local', 'hidden', 'month', 'number', 'range', 'search', 'tel', 'time',
                  'url', 'week', ]),
                </CommonHowToUse>
              </CardHeader>
              <CardBody>
            ...
            <Card stretch>
              ...
              <CardBody>
                <form className="row g-4">
                  ...
                  <FormGroup className="col-6" id="exampleAC--cc-number" label="Credit Card Number">
                    <Input
                      type="number"
                  ...
                  <FormGroup className="col-3" id="exampleAC--cvc-number" label="Name">
                    <Input type="number" autoComplete="cc-csc" placeholder="CVC Number" required />
                  </FormGroup>
                  <FormGroup className="col-3" id="exampleAC--expiry" label="Expiry">
                    <Input type="text" autoComplete="cc-exp" placeholder="MM/YYYY" required />
                  </FormGroup>
                </form>
              </CardBody>
              <CardFooter>
                <CommonDesc>
                  Credit card form is shown as an example. For detailed usage, you can{" "}
                  <a
          ...
          <div className="col-lg-6">
            <Card stretch>
              ...
              <CardHeader>
                <CommonHowToUse>size: PropTypes.oneOf(['lg', 'sm']),</CommonHowToUse>
              </CardHeader>
              <CardBody>
                <div className="row mb-4">
                  <FormGroup className="col" id="exampleSizeInputLg" label="Large input">
                    <Input
                      size="lg"
                  ...
                  <FormGroup className="col" id="exampleSizeInput" label="Default input">
                    <Input placeholder="Placeholder" aria-label="default size example" />
                  </FormGroup>
                  <FormGroup className="col" id="exampleSizeInputSm" label="Small input">
                    <Input
                      size="sm"
                      placeholder="Placeholder"
                ...
                <div className="row">
                  <FormGroup className="col" id="exampleSizeTextareaLg" label="Large textarea">
                    <Textarea size="lg" placeholder="Placeholder" />
                  </FormGroup>
                  <FormGroup className="col" id="exampleSizeTextarea" label="Default textarea">
                    <Textarea placeholder="Placeholder" />
                  </FormGroup>
                  <FormGroup className="col" id="exampleSizeTextareaLg" label="Small textarea">
              ...
              <CardFooter>
                <CommonDesc>
                  Set heights using size props like <code>lg</code> and <code>sm</code>.
                </CommonDesc>
              </CardFooter>
            </Card>
          </div>
            ...
            <Card stretch>
              ...
              <CardBody>
                <div className="row g-4 mb-4">
                  <FormGroup className="col" id="exampleDisableInput" label="Disabled input">
                    <Input
                ...
                <div className="row g-4">
                  <FormGroup className="col" id="exampleDisableTextarea" label="Disabled textarea">
                    <Textarea
              ...
              <CardFooter>
                <CommonDesc>
                  <p>
                    Add the <code>disabled</code> boolean attribute on an input to give it a grayed
                    out appearance and remove pointer events.
                  </p>
                  <p>
                    A <code>disabled</code> element isn't editable and isn't sent on submit.
                  </p>
                </CommonDesc>
              </CardFooter>
            </Card>
            ...
            <Card stretch>
              ...
              <CardBody>
                <Card className="rad">
                  ...
                  <CardBody>
                    <FormGroup id="exampleReadOnlyInput" label="Read only input">
                      <Input
                ...
                <Card>
                  ...
                  <CardFooter>
                    <CommonDesc>
                      If you want to have <code>&#60;Input readOnly/&#62;</code> components in your
                      form styled as plain text, use the <code>readOnly="plaintext"</code> props to
            ...
            <Card stretch tag="form" onSubmit={formik.handleSubmit}>
              ...
              <CardBody>
                <div className="row g-4">
                  ...
                  <FormGroup className="col-md-3" id="formMiddleName" label="Middle Name">
                    <Input
                      placeholder="John"
                  ...
                  <FormGroup className="col-md-4" id="formSurName" label="Sur Name">
                    <Input
                      placeholder="Doe"
                  ...
                  <FormGroup className="col-lg-6" id="formEmailAddress" label="Email Address">
                    <Input
                      type="email"
              ...
              <CardFooter>
                ...
                <CardFooterRight>
                  <Button type="submit" color="info" onClick={() => setModalStatus(true)}>
                    Submit
                  </Button>
                </CardFooterRight>
              </CardFooter>
          ...
          <div className="col-lg-6">
            <Card>
              ...
              <CardHeader>
                <CommonHowToUse>list: PropTypes.arrayOf(PropTypes.string),</CommonHowToUse>
              </CardHeader>
              <CardBody>
              ...
              <CardFooter>
                <CommonDesc>
                  <p>
                    Datalists allow you to create a group of <code>&#60;option&#62;</code>s that can
                    be accessed (and autocompleted) from within an <code>&#60;input&#62;</code>.
                    These are similar to <code>&#60;select&#62;</code> elements, but come with more
                    menu styling limitations and differences. While most browsers and operating
                    systems include some support for <code>&#60;datalist&#62;</code> elements, their
                    styling is inconsistent at best.
                  </p>
                  <p>
                    Learn more about{" "}
                    <a href="https://caniuse.com/datalist" target="_blank" rel="noreferrer">
            ...
            <Card tag="form" onSubmit={formikEvents.handleSubmit}>
              <CardHeader>
                <CardLabel icon="Bolt" iconColor="warning">
                  <CardTitle>onBlur, onChange, onFocus, onInput, onInvalid, onSelect,</CardTitle>
                  <CardSubTitle>Input and Textarea</CardSubTitle>
                </CardLabel>
              </CardHeader>
              <CardHeader>
                ...
                <div className="row g-4">
                  <FormGroup id="exampleEvent" className="col-12" label="Events">
                    <Input
                      ...
                      onBlur={() => showNotification("Trigger onBlur", "This input trigger onBlur")}
                      onChange={formikEvents.handleChange}
                      onFocus={() =>
                        showNotification("Trigger onFocus", "This input trigger onFocus")
                      }
                      onInput={() =>
                        showNotification("Trigger onInput", "This input trigger onInput")
                      }
                      onInvalid={() =>
                        showNotification("Trigger onInvalid", "This input trigger onInvalid")
                      }
                      onSelect={() =>
                        showNotification("Trigger onFocus", "This input trigger onSelect")
                      }
                    />
                  </FormGroup>
                  <FormGroup id="exampleEventTextarea" className="col-12" label="Events">
                    <Textarea
                      required
                      placeholder="Type to search..."
                      onBlur={() => showNotification("Trigger onBlur", "This input trigger onBlur")}
              ...
              <CardFooter>
                <CommonDesc>
                  <ul>
                    <li>
                      <b>onBlur</b> Fires the moment that the element loses focus
                    </li>
                    <li>
                      <b>onChange</b> Fires the moment when the value of the element is changed
                    </li>
                    <li>
                      <b>onFocus</b> Fires the moment when the element gets focus
                    </li>
                    <li>
                      <b>onInput</b> Script to be run when an element gets user input
                    </li>
                    <li>
                      <b>onInvalid</b> Script to be run when an element is invalid
                    </li>
                    <li>
                      <b>onSelect</b> Fires after some text has been selected in an element
                    </li>
                  </ul>
                </CommonDesc>
              </CardFooter>
            ...
            <ModalBody>
              <div className="row g-4">
                ...
                <div className="col-9">
                  ...
                  {formik.values.formMiddleName && `${formik.values.formMiddleName} `}
