      ...
      <SubHeader>
        ...
        <SubHeaderRight>
          ...
          {TABS.ADDRESS === activeTab && (
            <Button color="info" isOutline icon="Save" onClick={formikAddress.handleSubmit}>
              Save
            </Button>
          )}
        </SubHeaderRight>
      ...
      <Page container="fluid">
        <div className="row h-100">
                  ...
                  <div className="col-12 shadow-3d-container">
                      ...
                      <CardBody>
                        <div className="d-flex align-items-center pb-3">
                          ...
                          <div className="flex-grow-1 ms-3">
                            <div className="fw-bold fs-3 mb-0">{priceFormat(250)}</div>
                            <div className="text-muted">You can use it within 15 days.</div>
                          </div>
                        </div>
                      </CardBody>
                    </Card>
                    ...
                    >
                      ...
                      <CardBody>
                        <div className="d-flex align-items-center pb-3">
                          <div className="flex-shrink-0">
                            <Icon icon="CardGiftcard" size="4x" color="warning" />
                          </div>
                          <div className="flex-grow-1 ms-3">
                            <div className="fw-bold fs-3 mb-0">{priceFormat(100)}</div>
                            <div className="text-muted">You can use it within 3 days.</div>
                          </div>
                        </div>
                      </CardBody>
                    </Card>
          ...
          <div className="col-xxl-9 col-xl-8 col-lg-6">
                  ...
                  <Card>
                    ...
                    <CardBody>
                      <div className="row g-4">
                        ...
                        <div className="col-xl-4">
                          <FormGroup id="confirmPassword" label="Confirm new password" isFloating>
                            <Input
                              type="password"
            ...
            {TABS.ADDRESS === activeTab && (
              <Card stretch tag="form" noValidate onSubmit={formikAddress.handleSubmit}>
                <CardHeader>
                    ...
                    <div className="col-lg-12">
                      <FormGroup id="addressLine" label="Address Line" isFloating>
                        <Input
                          ...
                          invalidFeedback={formikAddress.errors.addressLine}
                          validFeedback="Looks good!"
                        />
                      </FormGroup>
                    </div>
                ...
                <CardFooter>
                  <CardFooterLeft>
                    <Button color="info" isLink type="reset" onClick={formikAddress.resetForm}>
                      Reset
                    </Button>
                  </CardFooterLeft>
                  <CardFooterRight>
                    <Button
                      ...
                      color="info"
                      isOutline
                      isDisable={!formikAddress.isValid && !!formikAddress.submitCount}
                    >
                      Save
                    </Button>
                  </CardFooterRight>
            ...
            {TABS.APPOINTMENT === activeTab && (
              <Card stretch style={{ minHeight: 600 }}>
                  ...
                  <CardActions>
                    <ButtonGroup isToolbar>
                      <CalendarTodayButton
                        ...
                        viewMode={viewMode}
                      />
                      <CalendarViewModeButtons setViewMode={setViewMode} viewMode={viewMode} />
                    </ButtonGroup>
                  </CardActions>
                </CardHeader>
                <CardBody isScrollable>
                ...
                >
                  <OffCanvasHeader setOpen={setToggleInfoEventCanvas} className="p-4">
                    <OffCanvasTitle id="canvas-title">Edit Event</OffCanvasTitle>
                  </OffCanvasHeader>
                  <OffCanvasBody tag="form" onSubmit={formikEvent.handleSubmit} className="p-4">
                    <div className="row g-4">
                      <div className="col-12">
                        ...
                        <Card className="mb-0 bg-l10-info" shadow="sm">
                          <CardHeader className="bg-l25-info">
                            <CardLabel icon="DateRange" iconColor="info">
                              <CardTitle className="text-info">Date Options</CardTitle>
                            </CardLabel>
                          </CardHeader>
                          <CardBody>
                            <div className="row g-3">
                              <div className="col-12">
                                <FormGroup id="eventAllDay">
                                  <Checks
                                    ...
                                    value="true"
                                    label="All day event"
                                    checked={formikEvent.values.eventAllDay}
                                    onChange={formikEvent.handleChange}
                                  />
                                </FormGroup>
                              </div>
                              <div className="col-12">
                                <FormGroup
                                  id="eventStart"
                                  label={formikEvent.values.eventAllDay ? "Date" : "Start Date"}
                                >
                                  <Input
                                    type="date"
                                    value={moment(formikEvent.values.eventStart).format(
                                      "YYYY-MM-DD"
                                    )}
                                    onChange={formikEvent.handleChange}
                                  />
                              ...
                              {!formikEvent.values.eventAllDay && (
                                <div className="col-12">
                                  <FormGroup id="eventEnd" label="End Date">
                                    <Input
                                      type="date"
                                      value={moment(formikEvent.values.eventEnd).format(
                                        "YYYY-MM-DD"
                                      )}
                                      onChange={formikEvent.handleChange}
                                    />
                      ...
                      <div className="col-12">
                        <Card
                          className={classNames("bg-l10-success", {
                            "mb-4 shadow-3d-success": !formikEvent.values.eventRecurring,
                        ...
                        >
                          <CardHeader className="bg-l25-success">
                            <CardLabel icon="DateRange" iconColor="success">
                              <CardTitle className="text-success">Date Options</CardTitle>
                            </CardLabel>
                          </CardHeader>
                          <CardBody>
                            <div className="row g-3">
                              <div className="col-12">
                                <FormGroup id="eventRecurring">
                                  <Checks
                                    ...
                                    checked={formikEvent.values.eventRecurring}
                                    onChange={formikEvent.handleChange}
                                  />
                                </FormGroup>
                              </div>
                              {formikEvent.values.eventRecurring && (
                                <>
                                  <div className="col-12">
                                    <FormGroup id="eventRepeat" label="Repeat Event">
                                      <Select
                                        value={formikEvent.values.eventRepeat}
                                        onChange={formikEvent.handleChange}
                                  ...
                                  <div className="col-12">
                                    <FormGroup id="eventUntilWhen" label="Until when?">
                                      <Input
                                        type="date"
                                        value={formikEvent.values.eventUntilWhen}
                                        onChange={formikEvent.handleChange}
                                      />
                                    </FormGroup>
                                  </div>
                          ...
                          <Card className="mb-0 bg-l10-dark" shadow="sm">
                            ...
                            <CardBody>
                              <FormGroup id="eventEmployee" label="Employee">
                                <Input
                                  value={formikEvent.values.eventEmployee}
                                  onChange={formikEvent.handleChange}
                                  list={Object.keys(USERS).map(
                                    (u) => `${USERS[u].name} ${USERS[u].surname}`
                                  )}
                                />
                              </FormGroup>
                            </CardBody>
