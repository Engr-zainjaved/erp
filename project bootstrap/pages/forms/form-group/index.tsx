...
<FormGroup
  ...
  return (
    <PageWrapper>
      <Head>
        <title>{componentPagesMenu.forms.subMenu.formGroup.text}</title>
      </Head>
      <SubHeader>
        <SubHeaderLeft>
          <Breadcrumb
        ...
        <div className="row">
            ...
            <Card>
              <CardHeader>
                <CardLabel icon="Assignment">
                  ...
                  <CardSubTitle>FormGroup, Label, Input, Textarea and FormText</CardSubTitle>
                </CardLabel>
              </CardHeader>
              <CardBody>
              ...
              <CardFooter>
                <CommonDesc>
                  You can use the FormGroup component in two different ways. In the first way, you
                  can customize it with html elements or components as you wish, but you should pay
                  attention to htmlFor and id props for a11y. In the second way, it makes your job
          ...
          <div className="col-lg-6">
            <Card stretch>
              ...
              <CardBody>
                ...
                <FormGroup className="mb-3" id="exampleLabelWithout" formText="This has no label">
            ...
            <Card stretch>
              ...
              <CardBody>
                ...
                <FormGroup className="mb-3">
                  ...
                  />
                  <FormText id="exampleLabelWithout2-text">This has no label</FormText>
                </FormGroup>
              </CardBody>
            </Card>
          </div>
          ...
          <div className="col-lg-6">
            <Card stretch>
              ...
              <CardBody>
                <p>
                  It is very easy to use in the first method, just type what you want to write in
                  the <code>formText</code> prop. It will automatically do what is required for the
                  accessibility. You can click on the Storybook link above to review the code
                  structure.
                </p>
                <FormGroup
                  className="mb-3"
          ...
          <div className="col-lg-6">
            <Card stretch>
              ...
              <CardBody>
                <FormGroup className="mb-3">
                  <p>
                    The first method is very easy to use, just type what you want to write in{" "}
                    <code>formText</code> prop. For accessibility you need to mark{" "}
                    <code>{`<FormText {...props}/>`}</code> with{" "}
                    <code>{`<Input {...props}/>`}</code>, <code>{`<Select {...props}/>`}</code> and{" "}
                    <code>{`<Textarea {...props}/>`}</code> with <code>ariaDescribedby</code>. You
                    can click on the Storybook link above to review the code structure.
                  </p>
                  ...
                  />
                  <FormText id="exampleFormText2-text">This is a form text</FormText>
                </FormGroup>
              </CardBody>
            </Card>
          </div>
          ...
          <div className="col-lg-6">
            <Card stretch>
              ...
              <CardBody>
                <p>
                  It is very easy to use it in the first method, just set the isFloating value to
                  true. You can click on the <b>Storybook</b> link above to examine the code
                  structure.
                </p>
                <FormGroup
                  className="mb-3"
          ...
          <div className="col-lg-6">
            <Card stretch>
              ...
              <CardBody>
                <p>
                  In the second method, you have to write some things yourself. For{" "}
                  <code>{`<Label htmlFor='...'>...</Label>`}</code>, you must write the htmlFor
                  value.You can click on the <b>Storybook</b> link above to examine the code
                  structure.
                </p>
                <FormGroup className="mb-3">
                  ...
                  />
                  <FormText id="exampleFloat2-text">When the value of isFloating is false</FormText>
                </FormGroup>
              ...
              <CardFooter>
                <CommonDesc>
                  Wrap a pair of <code>{`<Input {...props}>, <Select {...props}`}</code> or{" "}
                  <code>{`<Textarea {...props} />`}</code> and <code>{`<Label>`}</code> component in{" "}
                  <code>{`<FormGroup isFloating {...props}>...</FormGroup>`}</code> to enable
                  floating labels with Bootstrap’s textual form fields. A <code>placeholder</code>{" "}
                  is required on each <code>{`<input>`}</code> as our method of CSS-only floating
                  labels uses the <code>:placeholder-shown</code> pseudo-element. Also note that the{" "}
                  <code>{`<Input {...props}>, <Select {...props}`}</code> or{" "}
                  <code>{`<Textarea {...props} />`}</code> must come first so we can utilize a
              ...
              <CardFooter>
                <CommonDesc>
                  <p>
                    ...
                    achieve this is to use a <code>{`<Label>`}</code> component, or—in the case of
                    buttons—to include sufficiently descriptive text as part of the{" "}
                    <code>{`<Button>...</Button>`}</code> content.
                  </p>
                  <p>
                    For situations where it’s not possible to include a visible{" "}
                    <code>{`<Label>`}</code> or appropriate text content, there are alternative ways
                    of still providing an accessible name, such as:
                  </p>
                  <ul>
                    <li>
                  ...
                  <p>
                    ...
                    placeholder attribute as a fallback for the accessible name on{" "}
                    <code>{`<Input>`}</code> and <code>{`<Textarea>`}</code> components.
                  </p>
                  <p>
                    While using visually hidden content (<code>isHiddenLabel</code>,{" "}
                    <code>aria-label</code>, and even <code>placeholder</code> content, which
                    disappears once a form field has content) will benefit assistive technology
                    users, a lack of visible label text may still be problematic for certain users.
                    Some form of visible label is generally the best approach, both for
            ...
            <Card stretch>
              ...
              <CardBody>
                <FormGroup>
                  ...
                  <Input id="exampleHiddenLabel2" placeholder="Name" ariaLabelledby="Name" />
                </FormGroup>
              </CardBody>
            </Card>
          </div>
          ...
          <div className="col-lg-6">
            <Card stretch>
              ...
              <CardHeader>
                <CommonHowToUse>size: PropTypes.oneOf([null, 'lg', 'sm']),</CommonHowToUse>
              </CardHeader>
              <CardBody>
                <FormGroup
                  className="mb-3"
            ...
            <Card stretch>
              ...
              <CardBody>
                <FormGroup className="mb-3">
                  ...
                  />
                  <FormText id="exampleSizeSm2-text">This is a small field</FormText>
                </FormGroup>
                <FormGroup className="mb-3">
                  ...
                  />
                  <FormText id="exampleSize2-text">This is a default field</FormText>
                </FormGroup>
                <FormGroup className="mb-3">
                  ...
                  />
                  <FormText id="exampleSizeLg2-text">This is a large field</FormText>
                </FormGroup>
              </CardBody>
            </Card>
          </div>
            ...
            <Card stretch>
              <CardHeader>
                <CardLabel icon="ViewColumn">
                  <CardTitle>
                    isColForLabel, labelClassName and childWrapperClassName {FIRST_WAY}
                  </CardTitle>
                  <CardSubTitle>FormGroup</CardSubTitle>
                </CardLabel>
                <CardActions>
              ...
              <CardFooter>
                <CommonDesc>
                  In this use, it automatically adds the <code>row</code> class to the{" "}
            ...
            <Card stretch>
              ...
              <CardBody tag="form" onSubmit={formik2.handleSubmit}>
                <FormGroup className="mb-3 row">
                  <Label htmlFor="exampleColForLabelMail2" className="col-sm-2" isColForLabel>
                    Email
                  </Label>
                ...
                <FormGroup className="mb-3 row">
                  <Label htmlFor="exampleColForLabelPassword2" className="col-sm-2" isColForLabel>
                    Password
                  </Label>
                  <div className="col-sm-10">
                    <Input
          ...
          <Modal isOpen={modalStatus} setIsOpen={setModalStatus} titleId="exampleModalLabel">
            ...
            <ModalBody>
              <div className="row g-4">
                ...
                <div className="col-9">{formik.values.exampleColForLabelPassword}</div>
              </div>
            </ModalBody>
            <ModalFooter>
              <Button
          ...
          <Modal isOpen={modalStatus2} setIsOpen={setModalStatus2} titleId="exampleModalLabel2">
            <ModalHeader>
            ...
            <ModalBody>
              <div className="row g-4">
                ...
                <div className="col-9">{formik2.values.exampleColForLabelMail2}</div>
                <div className="col-3">
                  <b>Password:</b>
                </div>
                <div className="col-9">{formik2.values.exampleColForLabelPassword2}</div>
              </div>
            </ModalBody>
            <ModalFooter>
              <Button
