...
<InputGroup
  ...
  return (
    <PageWrapper>
      <Head>
        <title>{componentPagesMenu.forms.subMenu.inputGroup.text}</title>
      </Head>
      <SubHeader>
        <SubHeaderLeft>
          <Breadcrumb
        ...
        <div className="row">
            ...
            <Card stretch tag="form" onSubmit={formik.handleSubmit}>
              ...
              <CardBody>
                <p>
                  ...
                  both sides of an input. Remember to place <code>{`<Label>`}</code>s outside the
                  input group.
                </p>
                <div className="row g-4">
                  ...
                  <FormGroup>
                    ...
                    <InputGroup>
                      ...
                      />
                      <InputGroupText id="addon2">@example.com</InputGroupText>
                    </InputGroup>
                  </FormGroup>
                  <FormGroup>
                    <Label htmlFor="exampleUrl">Your vanity URL</Label>
                    <InputGroup>
                      <InputGroupText id="addon3">https://example.com/users/</InputGroupText>
                      <Input
                        id="exampleUrl"
                  ...
                  <FormGroup>
                    <Label htmlFor="exampleCompanyEmail">Company email address</Label>
                    <InputGroup>
                      <Input
          ...
          <div className="col-lg-6">
            <Card stretch>
              ...
              <CardHeader>
                <CommonHowToUse>size: PropTypes.oneOf(['sm', 'lg']),</CommonHowToUse>
              </CardHeader>
              <CardBody>
                <p>
                  Add the relative form sizing prop to the <code>InputGroup</code> itself and
                  contents within will automatically resize—no need for repeating the form control
                ...
                <div className="row g-4">
                  ...
                  <InputGroup size="lg">
                    <InputGroupText id="inputGroup-sizing-lg">Default</InputGroupText>
                    <Input
                      ariaLabel="Sizing example input"
              ...
              <CardFooter>
                <CommonDesc>
                  <b>Sizing on the individual input group elements isn’t supported.</b>
                </CommonDesc>
              </CardFooter>
            </Card>
          </div>
          ...
          <div className="col-lg-6">
            <Card stretch>
              ...
              <CardFooter>
                <CommonDesc>
                  Input groups wrap by default via wrap in order to accommodate custom form field
                  validation within an input group. You may disable this with{" "}
                  <code>{`isWrap={false}`}</code>.
                </CommonDesc>
              </CardFooter>
            </Card>
          </div>
          <div className="col-lg-6">
            <Card stretch>
                        ...
                        <InputGroup>
                          <InputGroupText tag="div" id="addon-wrapping">
                            <Checks
                              ...
                              checked={formikCR.values.exampleInputCheck}
                            />
                          </InputGroupText>
                          <Input
                            id="exampleInput"
                            ...
                            disabled={!formikCR.values.exampleInputCheck}
                          />
                        </InputGroup>
                      </FormGroup>
                      <FormGroup>
                        <InputGroup>
                          <InputGroupText tag="div" id="addon-wrapping2">
                            <Checks
                              ...
                              onChange={formikCR.handleChange}
                              checked={formikCR.values.exampleInputCheck2}
                            />
                          </InputGroupText>
                          <Input
                            id="exampleInput2"
                            ...
                            disabled={!formikCR.values.exampleInputCheck2}
                          />
                ...
                <Card>
                  <CardBody>
                    <div className="row g-4">
                      <FormGroup>
                        <InputGroup>
                          <InputGroupText tag="div" id="addon-wrapping-radio">
                            <Checks
                              ...
                              onChange={formikCR.handleChange}
                              value="username"
                              checked={!!formikCR.values.exampleInputRadio}
                            />
                          </InputGroupText>
                          <Input
                            id="exampleInput3"
                            ...
                            disabled={formikCR.values.exampleInputRadio !== "username"}
                          />
                        </InputGroup>
                      </FormGroup>
                      <FormGroup>
                        <InputGroup>
                          <InputGroupText tag="div" id="addon-wrapping2-radio">
                            <Checks
                          ...
                          <Input
                            ...
                            disabled={formikCR.values.exampleInputRadio !== "email"}
                          />
                          <InputGroupText>@</InputGroupText>
                          <Input
                            id="exampleInput5"
              ...
              <CardFooter>
                <CommonDesc>
                  <code>isFormCheckInput</code> is automatically detected and added. 🥳
                </CommonDesc>
              </CardFooter>
            </Card>
          </div>
          ...
          <div className="col-lg-6">
            <Card stretch>
              ...
              <CardFooter>
                <CommonDesc>
                  While multiple <code>{`<Input>`}</code>s are supported visually, validation styles
                  are only available for input groups with a single <code>{`<Input>`}</code>.
                </CommonDesc>
              </CardFooter>
            </Card>
          </div>
            ...
            <Card stretch>
              ...
              <CardFooter>
                <CommonDesc>
                  ...
                  <code>{`<Checks>`}</code>) input versions.
                </CommonDesc>
              </CardFooter>
            </Card>
          </div>
              ...
              <CardBody>
                <Card>
                  ...
                  <CardBody>
                    <div className="row g-4">
                      <InputGroup>
                        <InputGroupText tag="label" htmlFor="inputGroupSelect01">
                          Options
                        </InputGroupText>
                        <Select
                ...
                <Card>
                  ...
                  <CardBody>
                    <div className="row g-4">
                      <InputGroup>
                        <InputGroupText tag="label" htmlFor="inputGroupFile01">
                          Only .pdf
                        </InputGroupText>
                        <Input id="inputGroupFile01" type="file" accept=".pdf" />
                      </InputGroup>
                      <InputGroup>
                        <Input type="file" />
        ...
        <Modal isOpen={modalStatus} setIsOpen={setModalStatus} titleId="exampleModalLabel">
          ...
          <ModalBody>
            <div className="row g-4">
              ...
              {formik.values.exampleCompanyEmail && formik.values.exampleCompanyServer && (
                <>
                  <div className="col-3">
                    <b>Price:</b>
                  </div>
